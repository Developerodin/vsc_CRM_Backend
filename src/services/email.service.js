  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .container { width: 100%; max-width: 700px; margin: 0 auto; padding: 20px; box-sizing: border-box; }
        .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
        .content { background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; }
        .greeting { font-size: 18px; margin-bottom: 20px; color: #2c3e50; }
        .summary-card { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.2); margin-bottom: 25px; text-align: center; }
        .task-count { font-size: 42px; font-weight: bold; color: #ffffff; margin-bottom: 10px; text-shadow: 0 2px 4px rgba(0,0,0,0.2); }
        .task-count-text { font-size: 18px; color: #ffffff; font-weight: 500; }
        .tasks-list { background: white; padding: 25px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-bottom: 25px; width: 100%; box-sizing: border-box; }
        ...
        .task-item { display: flex; align-items: flex-start; padding: 15px; margin-bottom: 15px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #667eea; flex-wrap: wrap; box-sizing: border-box; width: 100%; }
        ...
        .motivational-text { background: linear-gradient(135deg, #fff3cd 0%, #ffe69c 100%); padding: 18px; border-radius: 8px; margin: 20px 0; text-align: center; font-style: italic; color: #856404; font-weight: 500; border: 2px solid #ffc107; }
        @media (max-width: 480px) {
          .content { padding: 20px; }
          .tasks-list { padding: 18px; }
          .task-item { padding: 12px; }
          .task-meta { flex-direction: column; align-items: flex-start; gap: 6px; }
        }
      </style>
    </head>
    <body>
      <div class="container">
        ...
        <div class="footer">
          ...
          <p style="margin-top: 10px; font-size: 12px; color: #999;">
            This is an automated reminder sent daily at 12:50 PM IST
          </p>
        </div>
      </div>
    </body>
